// generated on 2019-06-19 using generator-webapp 4.0.0-5
...
const build = series(
  ...
  parallel(
    lint,
    series(parallel(styles, scripts, views, modernizr), html),
    images,
    fonts,
    extras
  ),
...
let serve;
if (isDev) {
  serve = series(clean, parallel(styles, scripts, views, modernizr, fonts), startAppServer);
} else if (isTest) {
