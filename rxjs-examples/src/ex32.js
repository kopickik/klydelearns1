...
function dragMe(sprite, spriteContainer) {
    ...
    let spriteContainerMouseMoves = Rx.Observable.fromEvent(spriteContainer, "mousemove")
    let spriteContainerMouseUps = Rx.Observable.fromEvent(spriteContainer, "mouseup")
